...
@section('content')
<div class="container">
<img src="/images/p200edited.png" alt="aircompressir" width="500px" height="auto">
    <div class="heading-04">
        <h4><b>Coltri MCH 13-16-21-23 Mark 3
</b></h4>
        <p>Frame: Mark 3 TPS - Line: Prime
The transportable compressor units with optimised equipment for use in vehicles and on ships
