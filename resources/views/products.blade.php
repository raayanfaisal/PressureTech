    ...
    <div class="row">
        <div class="col-md-4 col-sm-6">
            <div class="product-grid2">
                <div class="product-image2"> <a href="#"> <img class="pic-1" src="/images/COLTRI COMPRESSOR MCH 13 MCH 16 SUPER SILENT EVO.png"> <img class="pic-2" src="/images/compressor-coltri.png"> </a>
                    <ul class="social">
        ...
        <!-- Modal -->
<div id="one" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">COLTRI Compressor</h4>
      </div>
      <div class="modal-body">
        <p>Branded High pressure breathing air compressors</p>
      </div>
      <div class="modal-footer">
        ...
        <!-- Modal -->
<div id="two" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h4 class="modal-title">Diving Cylinder</h4>
      </div>
      <div class="modal-body">
        <p>Diving cylinders and Oxygen Kits</p>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
      </div>
        ...
        <div class="col-md-4 col-sm-6">
            <div class="product-grid2">
                <div class="product-image2"> <a href="#"> <img class="pic-1" src="/images/regulator-bcd-set.jpeg"> <img class="pic-2" src="/images/regulator-bcd-set.jpeg"> </a>
                    <ul class="social">
                        <li><a href="#" data-tip="Quick View"><i class="fa fa-eye"></i></a></li>
                        <li><a href="#" data-tip="Add to Cart"><i class="fa fa-shopping-cart"></i></a></li>
                    </ul>
                ...
                <div class="product-content">
                <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#three">See details.</button>
                </div>
            </div>
        </div>
    </div>
...
<div id="three" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h4 class="modal-title">Regulator BCD set</h4>
      </div>
      <div class="modal-body">
        <p>Complete dive gear </p>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
      </div>
...
<div id="five" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h4 class="modal-title">Oxygen Kits</h4>
      </div>
      <div class="modal-body">
        <p>Oxygen Kits</p>
      </div>
