...
system with two Hyperfilters, this series is powered by a three-phase electric motor, equipped with four
 different pumping units (MCH 13, MCH 16, MCH 21 and MCH 23), all in TPS (Tropical Plus Superdry) version
  and available with operation monitoring system and electrical display to automatically shutdown the
   compressor.</p>
        <img src="" alt="" >
    </div>
</div>
