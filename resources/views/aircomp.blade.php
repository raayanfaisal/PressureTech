...
Coltri Compact Evo</b></h2>
        ...
        They are equipped with three-phase motors and powerful pumping units (MCH 13, MCH 16 and MCH 18 depending on the specific model), 
        automatic condensate drain and electric panel for management of the automatic shut-off of the compressor.
        The remote filling panel can be added as an option.
</p>
        <img src="" alt="" >
    </div>
</div>
